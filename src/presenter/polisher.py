...
def _compose_system_prompt(context: dict[str, Any]) -> str:
    ...
    parts.extend([
        ...
        "   - `section_header`: styles for accordion/tab section headers (h3 elements)",
        "   - `section_content`: styles for section content wrappers",
        "   - `card`: styles for condition/entity cards",
        "   - `chip`: styles for type/category chips/badges",
        "   - `badge`: styles for managed/status badges",
        "   - `timeline_node`: styles for timeline entries",
        "   - `prose`: styles for prose/text blocks",
        "   - `accent_color`: single hex color for primary accent",
        "   - `view_wrapper`: styles for the outer view container",
